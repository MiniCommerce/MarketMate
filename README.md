...
- 회원정보 페이지
    - (구매자) 주문 현황, 회원 정보 수정, 비밀번호 변경, 회원 탈퇴 기능을 사용할 수 있습니다.
    - (판매자) 내 판매 상품, 회원 정보 수정, 비밀번호 변경, 회원 탈퇴 기능을 사용할 수 있습니다.
![회원정보](./readme_images/06_회원정보.png)

- 회원정보 수정 페이지
    - 구매자와 판매자의 회원정보 수정 페이지를 별도로 구성하였습니다.
    - (구매자) 닉네임, 전화번호, 배송지를 수정할 수 있습니다.
    - (판매자) 판매처, 전화번호, 출고지를 수정할 수 있습니다.
![회원정보수정](./readme_images/07_회원정보수정.png)

- 비밀번호 변경 페이지
    - 현재 로그인한 회원의 비밀번호를 변경할 수 있습니다.
![비밀번호수정](./readme_images/08_비밀번호수정.png)

- 회원탈퇴 페이지
    - 현재 로그인한 회원이 회원탈퇴할 수 있습니다.
    - 회원탈퇴한 회원의 정보는 삭제되는 것이 아니라 비활성화됩니다.
![회원탈퇴](./readme_images/09_회원탈퇴.png)

- 상품 목록 페이지
    - 현재 등록된 모든 상품의 목록을 확인할 수 있습니다.
    - 검색창을 통해 검색하거나, 카테고리 버튼을 눌러 각 카테고리에 맞는 상품만 필터링 할 수 있습니다.
![상품목록](./readme_images/10_상품목록.png)
...
![장바구니](./readme_images/16_장바구니.png)
